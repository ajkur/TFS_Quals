...
%     sign convention for work (p. 37, 6th ed.)
%     difference between inexact and exact differentials (pp. 37-38, 6th ed.)
%     sign convention for heat transfer (p. 48, 6th ed.)
%     first law (p. 52, 6th ed.)
%     definition of thermal efficiency (p. 66, 6th ed.)
%     definition of coefficient of performance (p. 67, 6th ed.)
